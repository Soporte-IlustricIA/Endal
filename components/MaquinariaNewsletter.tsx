...
export default function MaquinariaNewsletter() {
    ...
    <section className="al-newsletter">
      <div className="al-newsletter__left">
        ...
        <p className="al-newsletter__copy">
          Para más información sobre nuestra maquinaria de envasado
          o para recibir fichas técnicas de los equipos,
          suscríbete a las <em>noticias ENDAL</em>.
