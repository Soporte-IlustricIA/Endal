...
export default function PapelNewsletter() {
    ...
    <section className="al-newsletter">
      <div className="al-newsletter__left">
        ...
        <p className="al-newsletter__copy">
          Para más novedades sobre nuestros productos de papel de aluminio
          o para descubrir otras soluciones de conservación,
